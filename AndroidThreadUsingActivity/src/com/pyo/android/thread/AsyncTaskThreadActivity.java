...
public class AsyncTaskThreadActivity extends Activity {
	...
	public void onCreate(Bundle  savedInstanceState){
		...
		Button asyncTaskThreadStart = (Button)findViewById(R.id.btn_asynctask_thread);
		asyncTaskThreadStart.setOnClickListener(
				new View.OnClickListener(){	
					
					@Override
					public void onClick(View v){
						//AsyncTask는 반드시 Main UI Thread 영역에서 실행되어야 함
	...
	private  class  AsyncTaskThreadImpl extends AsyncTask<Integer, Integer, String> {
		...
		//publishProgress(,)에서 던져진 작업 목록을 UI Thread영역에서 실행
		@Override
