...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		urlView = (EditText)findViewById(R.id.searchText);
		list = (ListView)findViewById(R.id.listView1);
		Button btn = (Button)findViewById(R.id.seachButton);
		btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (urlString != null && !urlString.equals("")) {
					...
					NaverBookRequest request = new NaverBookRequest(urlString);
					NetworkModel.getInstance().getNetworkData(request, 
						...
						public void onCompleted(NetworkRequest request) {
							...
							NaverBookRequest rq = (NaverBookRequest)request;
							NaverBooks naverMovies = rq.getResult();
