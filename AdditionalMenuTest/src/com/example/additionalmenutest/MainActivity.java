...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mActionBar.setNavigationMode(ActionBar.NAVIGATION_MODE_LIST);  //리스트 모드 액션바 내비게이션 set

		mAdapter = new ArrayAdapter(this, android.R.layout.simple_spinner_item, menus);  //스피너를 연결시켜주는 어댑터
